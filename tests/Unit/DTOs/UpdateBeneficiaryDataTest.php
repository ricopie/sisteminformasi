...
class UpdateBeneficiaryDataTest extends TestCase
{
    #[Test]
    public function it_can_create_via_constructor_with_all_fields(): void
    {
        ...
        $beneficiary = new UpdateBeneficiaryData(
            nik: $nik,
    ...
    #[Test]
    public function it_can_create_with_all_nulls(): void
    {
        $beneficiary = new UpdateBeneficiaryData;

        $this->assertNull($beneficiary->nik);
        $this->assertNull($beneficiary->type);
        $this->assertNull($beneficiary->fullName);
        $this->assertNull($beneficiary->nickName);
        $this->assertNull($beneficiary->birthPlace);
        $this->assertNull($beneficiary->birthDate);
        $this->assertNull($beneficiary->gender);
    ...
    #[Test]
    public function it_can_create_via_static_from_with_partial_data(): void
    {
        $data = [
            'fullName' => 'John Doe',
            'birthPlace' => 'Jakarta',
        ...
        $beneficiary = UpdateBeneficiaryData::from($data);
